...
// VersiÃ³n: 1.0 | App: inventario-larusia
//
// INSTRUCCIONES:
...
const APP_NAMESPACE = 'inventario_larusia';
  ...
  async function loadAllFromFirebase() {
    ...
    try {
      ...
      if (snap.exists()) {
        ...
        console.log('â¹ï¸ Firebase: No hay datos en la nube todavÃ­a (primera vez)');
      }
    } catch(e) {
...
console.log('â firebase-sync.js cargado | App:', 'inventario_larusia');
